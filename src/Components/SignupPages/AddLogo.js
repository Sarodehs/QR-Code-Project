          ...
          <div class="card text-white borderradi">
            ...
            <h4 className=" m-3">Add Restaurant Logo </h4>
              ...
              <div class="col-md-6 col-xl-7 col-sm-12 text-center  p-5 ">
                ...
                <NavLink to="" style={{ textDecoration: 'none' }}> <div className="d-grid gap-2 col-xl-9 col-md-6 col-sm-6 mx-auto ">
                  <button className="btn buttonfocuscolor" type="button" >UPLODE</button>
                </div></NavLink>
                <p>or</p>
                <NavLink to="/Generateqrcode/" style={{ color: 'orange', textDecoration: 'none' }}> <div className="d-grid gap-2 col-xl-12 col-md-6 col-sm-6 mx-auto ">
