            ...
            <div class="row g-0 ">
              <div class="col-md-6 col-xl-6 ">
                <div class="carousel-item active">
                  <img src="/assets/images/Branch.png" class="d-block w-100" alt="img" />
              ...
              <div class="col-md-6 col-xl-6 col-sm-12 text-center  ">
                ...
                <h4 className="m-4">Do you have multiple branches?</h4>
                  <div className="row g-0 mt-5">
                    ...
                    <div className="d-grid gap-2 col-xl-10 col-md-6 col-sm-6 mx-auto ">
                  <button className="btn buttonfocuscolor" type="button" >YES</button>
                </div></NavLink>
                    </div>
                    ...
                    <div className="d-grid gap-2 col-xl-10 col-md-6 col-sm-6 mx-auto ">
                  <button className="btn buttonfocuscolor" type="button" >NO</button>
                </div></NavLink>
                    </div>
                  </div>
              </div>
