    ...
    return(
        ...
        <div class="container-fluid">
            ...
            <div class="text-center mt-5 pricing">
                ...
                {/* <Link to="monthly/"> */}
                    <button class="btn btn-sm ps-4 pe-4 inputfocus silbtn">Monthly</button>
                    {/* </Link> */}
                {/* <Link to="/"> */}
                    <button class="btn btn-sm ps-4 pe-4 text-center inputfocus  navbtn">Yearly</button>
                    {/* </Link> */}
                ...
                <div class="yearly">
                    ...
                    <div class="row mt-5 d-flex justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12 mt-5 mb-5 text-center">
                            ...
                            <div class="card w-100 pb-5 freecard">
                                ...
                                <ul class="list-group text-start lh-lg m-2">

                                    <li class="list-group-item border-0 lh-md"><i class="fa fa-check pe-3" aria-hidden="true"></i>Easy Upload of your menu in the system<br/>
                                    ...
                                    <NavLink to="/register/"  style={{ textDecoration: 'none' }}><button type="button" class="btn btn-sm px-5 pe-5 ms-5 inputfocus  silbtn" >Chooose</button></NavLink>
                                    </li>
                        ...
                        {/* <!-- gold plan starts --> */}
                        <div class="col-xl-3 col-md-6 col-sm-12 mx-5 text-center">

                            {/* <!-- gold plan card start --> */}
                            <div class="card w-100 pb-5 goldcard">

                                {/* <!-- head part in gold plan card --> */}
                                <div class="card-header text-center mt-3">

                                    <h6 class="mx-5" style={{color: "#B5876D"}}>Gold Plan  </h6>
                                        <button class="btn btn-sm px-4 pe-4 inputfocus popularbtn rounded-pill"><small>Popular</small></button>
                                    {/* </h6> */}
                                    <h2><span class="material-icons-outlined fs-5">currency_rupee</span>05<span class="fs-5">K</span></h2>
                                ...
                                <ul class="list-group text-start">
                                    ...
                                    <li class="list-group-item border-0 lh-lg"><i class="fa-solid fa-circle pe-3"></i><b>Everything in a Silver plan</b><br/>
                                    ...
                                    <button type="button" class="btn px-5 pe-5 navbtn btn-sm inputfocus ms-5">Chooose</button>
                                    </li>
                        ...
                        {/* <!-- silver plan starts --> */}
                        <div class="col-xl-3  col-md-6 col-sm-12 mt-5 text-center">

                            {/* <!-- silver plan card start --> */}
                            <div class="card w-100 pb-5 silvercard">

                                {/* <!-- head part in silver plan card --> */}
                                <div class="card-header text-center mt-3">

                                    <h6 style={{color: "#B5876D"}}>Silver plan</h6>
                                    <h2><span class="material-icons-outlined fs-5">currency_rupee</span>04<span className="fs-5">K</span></h2>
                                    <p><small class="text-muted">Per member Per Month</small></p>
                                ...
                                <ul class="list-group text-start">
                                    ...
                                    <li class="list-group-item border-0 lh-lg pt-4"><i class="fa-solid fa-circle pe-3"></i><b>Everything in a Free plan</b><br/>
                                    <i class="fa fa-check pe-3 pt-4" aria-hidden="true"></i>Custom QR code(25 QR codes)<br/>
                                    <i class="fa fa-check pe-3 pt-4" aria-hidden="true"></i>Choose your own theme<br/>
                                    <i class="fa fa-check pe-3 pt-4" aria-hidden="true"></i>24*7 customer support<br/><br/><br/>
                                    <NavLink to="/checkout/" style={{ textDecoration: 'none' }}><button type="button" class="btn btn-sm px-5 pe-5 ms-5 inputfocus  silbtn" >Chooose</button></NavLink>
                                    </li> 
            ...
            <div class="cust mt-5 mb-5">
                ...
                <h3 class="ps-5 ms-5"><b>What our Customers say?</b></h3>
                ...
                <div class="text-center mt-5 mb-4 customer">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-xl-1 col-md-2 col-sm-4 mt-5 pt-4 picons">
                            <span class="material-icons fs-2">arrow_circle_left</span>  
                        </div>
                        
                        <div class="col-xl-1 col-md-2 col-sm-4 mt-5">
                            <img src="../assets/images/p1.png" width="90%" alt="first person"/>
                        </div>

                        <div class="col-xl-2 col-md-4 col-sm-8 mb-4">
                            <img src="../assets/images/p2.png"  width="80%" class="person2" alt="second person"/>   
                        </div>

                        <div class="col-xl-1 col-md-2 col-sm-4 mt-5 mb-4">
                            <img src="../assets/images/p3.png" width="90%" alt="third person"/>
                        </div>

                        <div class="col-xl-1  col-md-2 col-sm-4 mt-5 pt-4 picons">
                            <span class="material-icons fs-2 px-5">arrow_circle_right</span>
                        </div>
                ...
                <div class="customerreview">
                    <div class="card mx-auto mt-5 mb-5 w-50">
            ...
            {/* <!-- faq starts--> */}
            <div class="webfaq w-80 pt-5 ">                

            <h3 class="mb-5 ps-5 ms-5"><b>Frequently Asked Questions</b></h3>

                {/* accordion starts */}
                <div class="accordion accordion-flush w-80 px-5 mx-5"  id="accordionFlushExample">
