            ...
            <div class="row g-0">
              <div class="col-md-6 col-xl-6 col-sm-12 ">
               <div class="carousel-item active">
                  <img src="../assets/images/Signup.png" class="d-block w-100 h-100" alt="img" />
              ...
              <div class="col-md-6 col-xl-6 col-sm-12 text-center p-5 ">
                ...
                <div >
                  <a href="/" className="align-items-end justify-content-end d-flex p-3" style={{ color: 'orange', textDecoration: 'none' }}>forgot password?</a>
                </div>
                <NavLink to="/Details/"  style={{ textDecoration: 'none' }}> <div className="d-grid gap-2 col-xl-12 col-md-6 col-sm-6 mx-auto ">
               <button className="btn btn-warning buttonfocuscolor" type="button" >SIGN UP</button>
                </div></NavLink>
