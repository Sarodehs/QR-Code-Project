                    ...
                    <div className=" col-md-10 col-xl-10 col-sm-10 bg-light  p-4 justify-content-center " >
                        ...
                        <div className="row ">
                            ...
                            <h3 >Preview</h3>
                                <div className="row">
                                    <div className=" col-md-4 col-xl-4 col-sm-4 " >
                                        <img src={img1} className="img-fluid cardshadow selectthemeimgsize" alt="img" />
                                        <p >Dishes</p>
                                    </div>
                                    <div className="  col-md-4 col-xl-4 col-sm-4" >
                                        <img src={img2} className="img-fluid cardshadow selectthemeimgsize" alt="img" />
                                        <p >Menu</p>
                                    </div>
                                    <div className="  col-md-4 col-xl-4 col-sm-4" >
                                        <img src={img3} className="img-fluid  cardshadow selectthemeimgsize" alt="img" />
                                        <p >My Orders</p>
                                    </div>
                                </div>
                            </div>
