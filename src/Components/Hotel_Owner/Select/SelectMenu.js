                ...
                <div className="row ">
                    ...
                    <div className=" col-md-10 col-xl-10 col-sm-10 bg-light  p-4 justify-content-center " >
                        <div className="row ">
                            <div className="col-xl-3 col-md-3 col-sm-12">
                                ...
                                <div className="d-flex  SelectMenusidebar ">
                                    <ul className="nav align-items-center justify-content-center d-flex " id="menu">
                                        ...
                                        <div className="d-grid gap-2 col-xl-9 col-md-4 col-sm-4 mx-auto  mb-2" >
                                            <button href="/" className="buttonadd p-4" data-bs-toggle="modal" data-bs-target="#exampleModal">+ ADD NEW CATEGORY</button>
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    <div className="col-md-12  col-xl-12 card col-sm-12 cardwh">
                                                        <div className="row  g-0 p-5">
                                                            <div className="col-md-6  col-xl-7  col-sm-12">
                                                                ...
                                                                <div className="d-grid gap-2 col-xl-4 col-md-4 col-sm-3 mx-auto ">
                                                                    <button className="btn btn-warning buttonfocuscolor" type="button" >ADD CATEGORY</button>
                                                                </div>
                                                            </div>
                                                            <div className="col-md-6 col-xl-5  col-sm-12 p-5">
                                        ...
                                        <li className={({ isActive }) => (isActive ? 'main-nav-active' : 'inactive')}>                                         
                                            <NavLink to="/Menu/Starters/" style={{ textDecoration: 'none' }} >
                                                <a href="/#" className="nav-link d-flex">
                                                    <div class=" row g-0 align-items-center justify-content-center d-flex p-1">
                            ...
                            {/* <!-- Content area start --> */}
                            <div className=" col-md-9 col-xl-9 col-sm-12 bg-light  justify-content-center " >
