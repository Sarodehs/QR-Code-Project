...
class SelectWallpaper extends Component {
        ...
        constructor(props) {
            super(props);
            this.state = (<>
               <img alt=' '  className="m-auto selectthemeimgsize cardshadow"  src={img1} /></>);    
        }
        updateContent1 = () => {
            this.setState(<>
                 <img alt=' '  className="m-auto selectthemeimgsize cardshadow"  src={img1} /></>);  
        ...
        updateContent2 = () => {
            this.setState(<>
                <img alt=' '  className="m-auto selectthemeimgsize cardshadow"  src={img2} /></>);   
        };
        updateContent3 = () => {
            this.setState(<>
                <img alt=' '  className="m-auto selectthemeimgsize cardshadow"  src={img3} /></>);   
        };
        updateContent4 = () => {
            this.setState(<>
                 <img alt=' '  className="m-auto selectthemeimgsize cardshadow"  src={img4} /></>);  
        };
                    ...
                    <div className=" col-md-10 col-xl-10 col-sm-10 bg-light  p-4 justify-content-center " >
                        ...
                        <div className="row ">
                            ...
                            <div className=" col-md-4 col-xl-4  col-sm-4" >
                                ...
                                <div className="d-flex   ">
                                    <ul className="nav align-items-center justify-content-center d-flex w-100" id="menu">
                                        ...
                                        <div className="d-grid gap-2 col-xl-6 col-md-4 col-sm-4 mx-auto pt-5" >
                            ...
                            <div className=' priview-screen '>
                                      <h4 className="p-3">Preview</h4>
                                                {this.state}
                                                <p className="p-3">Main Screen</p>
                             </div>
                                {/* <h3 >Preview</h3>
