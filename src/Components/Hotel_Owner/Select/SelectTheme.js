...
class SelectTheme extends Component {
    constructor(props) {
        ...
        this.state = (<>
            ...
            <img src={imgA2} alt='img' className='selectthemeimgsize cardshadow ' />
          
            <img src={imgA3} alt='img' className='selectthemeimgsize cardshadow ' />
          </>);
    }
    ...
    updateContent2 = () => {
        this.setState(<>
            ...
            <img src={imgB2} alt='img' className='selectthemeimgsize cardshadow' />
            <img src={imgB3} alt='img' className='selectthemeimgsize cardshadow' /> </>);
    };
    updateContent3 = () => {
        this.setState(<>
            <img src={imgC1} alt='img' className='selectthemeimgsize cardshadow ' />
            <img src={imgC2} alt='img' className='selectthemeimgsize cardshadow ' />
            <img src={imgC3} alt='img' className='selectthemeimgsize cardshadow ' /> </>);
    };
    updateContent4 = () => {
        this.setState(<>
            <img src={imgD1} alt='img' className='selectthemeimgsize cardshadow ' />
            <img src={imgD2} alt='img' className='selectthemeimgsize cardshadow ' />
            <img src={imgD3} alt='img' className='selectthemeimgsize cardshadow ' /> </>);
    };
                    ...
                    <div className="row ">
                        ...
                        <div className=" col-md-10 col-xl-10 col-sm-10 bg-light  p-4 justify-content-center " >
                            ...
                            <div className="row ">
                                ...
                                <div className=" col-md-8 col-xl-8  col-sm-12 text-center ">
                                            <h2>Preview</h2>
                                            <div className=' priview-screen '>
                                                
                                                {this.state}
                                               <div className="row">
                                                   <p className="col-md-4"> Dishes </p>
                                                   <p className="col-md-4">Menu</p>
                                                   <p className="col-md-4"> My Order</p>
                                               </div>
