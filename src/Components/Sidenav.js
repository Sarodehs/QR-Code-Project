        ...
        <>
            <div className="container-fluid displayflex">
                <div className=" row px-2">
                    {/* <!-- side nav start --> */}
                    <div className="col-auto col-md-12 col-xl-12 col-sm-12 sidebar  " >
                        <div className="d-flex flex-column align-items-center w-100  vh-100 ">
                            <ul className="nav  flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                ...
                                <li >
                                     <NavLink to="Menu/" style={{ textDecoration: 'none'}}><a href="#submenu1" data-bs-toggle="collapse" className="nav-link align-middle d-flex">
                                        <i className="material-icons-outlined">restaurant_menu</i><span className="ms-3 d-none d-sm-inline"> Menu</span>
                                        <span className="material-icons-outlined w-100 text-end d-none d-md-block">  arrow_drop_down </span> 
                                        </a></NavLink>
